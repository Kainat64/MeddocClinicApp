    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.gridContainer}>
          <TouchableOpacity
            ...
            <ImageBackground
              ...
              <Image
                ...
                style={[styles.gridImage, styles.mt30]}
              />
            </ImageBackground>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={styles.gridItem}
            onPress={() => navigation.navigate('My Earning')}>
            <ImageBackground
              source={require('../assets/images/frame2.png')}
              style={styles.gridImageBackground}>
              <Text style={styles.gridText}> My earnings</Text>
              <Text style={styles.subText}> {walletBalance}</Text>
              <Image
          ...
          <TouchableOpacity
            style={styles.gridItem}
            onPress={() => navigation.navigate('Today Appointments')}>
            <ImageBackground
              ...
              <Image
                source={require('../assets/images/current_appointments.png')}
                style={[styles.gridImage, styles.mb20]}
              />
            </ImageBackground>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.gridItem}>
            <ImageBackground
              ...
              <Text style={styles.gridSubText}>Appointments</Text>
              <Image
                source={require('../assets/images/pending_appointments.png')}
                style={[styles.gridImage, styles.mb20]}
              />
            </ImageBackground>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.gridItem}>
            <ImageBackground
              ...
              style={styles.gridImageBackground}>
              <Text style={styles.gridText}>Upcomming </Text>
              <Text style={styles.gridSubText}>Appointments</Text>
              <Image
                source={require('../assets/images/cancel_appointments.png')}
                style={[styles.gridImage, styles.mb20]}
              />
            </ImageBackground>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={styles.gridItem}
            onPress={() => navigation.navigate('My Patients')}>
            <ImageBackground
              source={require('../assets/images/frame6.png')}
              style={styles.gridImageBackground}>
              <Text style={styles.gridText}>My Patients</Text>
              <Image
                source={require('../assets/images/patients_list.png')}
                style={[styles.gridImage, styles.mb20]}
              />
            </ImageBackground>
          </TouchableOpacity>
        ...
        <View style={styles.blogSection}>
          ...
          <ScrollView
            ...
            <TouchableOpacity style={styles.blogItem}>
              <Image
                source={require('../assets/images/heart_health.png')}
                style={styles.blogImage}
              />
              <Text style={styles.blogText}>
                Daily Tips for Prioritizing Your Heart Health
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.blogItem}>
              ...
              />
              <Text style={styles.blogText}>
                Healthy Whole Foods for Optimal Heart Health
              </Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
